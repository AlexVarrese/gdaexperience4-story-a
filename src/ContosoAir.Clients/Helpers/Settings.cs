...
namespace ContosoAir.Clients.Helpers
{
    ...
    public static class Settings
    {
        ...
        private const string FacebookBotAccountIdKey = "facebookbotaccountid_key";
        private const string DefaultFacebookBotAccountId = GlobalSettings.FacebookBotAccountId;

        private const string CognitiveServicesKeyKey = "cognitiveservices_key";
        private const string DefaultCognitiveServicesKey = GlobalSettings.CognitiveServicesKey;

        private const string BingSpeechApiKeyKey = "bingspeechapi_key";
        ...
        private const string GetFlightDetailsUrlKey = "getflightdetailsurl_key";
        private const string DefaultGetFlightDetailsUrl = GlobalSettings.GetFlightDetailsUrl;
        ...
        public static string FacebookBotAccountId
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(FacebookBotAccountIdKey, DefaultFacebookBotAccountId);
            }
            set
            {
                AppSettings.AddOrUpdateValue<string>(FacebookBotAccountIdKey, value);
            }
        }
        ...
        /*Azure function url property for getting Flight Data*/
        public static string GetFlightDetailsUrl
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(GetFlightDetailsUrlKey, DefaultGetFlightDetailsUrl);
            }
            set
            {
                AppSettings.AddOrUpdateValue<string>(GetFlightDetailsUrlKey, value);
            }
        }

        /*Logic App url property for inserting Flight feedback Data*/
        public static string LogicAppUrl
        {
            get
            {
                return AppSettings.GetValueOrDefault<string>(LogicAppUrlKey, DefaultLogicAppUrl);
            }
            set
            {
